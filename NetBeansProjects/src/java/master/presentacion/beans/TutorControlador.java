...
public class TutorControlador {
    ...
    private ArrayList<Tutor> lstTutorFilter;
    ...
    public ArrayList<Tutor> getLstTutorFilter() {
        return lstTutorFilter;
    }

    public void setLstTutorFilter(ArrayList<Tutor> lstTutorFilter) {
        this.lstTutorFilter = lstTutorFilter;
    }
...
//        this.obtenerRolesDadoCodigoUsuario();
        this.cargarRoles();
       // this.lstTutorFilter = new ArrayList<Tutor>();
    }
