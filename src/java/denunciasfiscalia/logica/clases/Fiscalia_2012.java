...
public class Fiscalia_2012 {
    ...
    private String domiciliado_vicitma;
    private Double x;
    private Double y;
    ...
    public Fiscalia_2012() {
    }

    public Fiscalia_2012(Date fecha_denuncia, String nombres_denunciante, String nombres_victima, String sexo_victima, String direccion_victima, String domiciliado_vicitma, Double x, Double y, String circuito, String codigo_circuito, String subcircuito, String codigo_subcircuito, int edad_victima, String estado_civil_victima, String instruccion_victima, String ocupacion_victima, String nombres_agresor, String sexo_agresor, String direccion_agresor, int edad_agresor, String domiciliado_agresor, String estado_civil_agresor, String instruccion_agresor, String ocupacion_agresor, String parentesco_agresor_victima, String numero_hijos, String direccion_agresion, String tipo_agresion, Date fecha_agresion, String hora_agresion, String medidas_amparo, String instruccion_fiscal, String sentencia, String apelacion, String observaciones, int id) {
        ...
        this.domiciliado_vicitma = domiciliado_vicitma;
        this.x = x;
        this.y = y;
    ...
    public String getDomiciliado_vicitma() {
        return domiciliado_vicitma;
    }

    public void setDomiciliado_vicitma(String domiciliado_vicitma) {
        this.domiciliado_vicitma = domiciliado_vicitma;
    }
