...
@ManagedBean
@RequestScoped
public class ControladorPermisosMTSubCircuito {

    /**
     * Creates a new instance of ControladorPermisosMTSubCircuito
     */
    ...
    public ControladorPermisosMTSubCircuito() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaSubCircuitos() {
        ...
        try {
            ...
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoSi = FLocales.ObtenerDatosDadoPermisoMtSubcircuito("Si", lstLocalesSubCircuito1.getSubcircuito());
            ...
            No.setLabel("No");
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoNo = FLocales.ObtenerDatosDadoPermisoMtSubcircuito("No", lstLocalesSubCircuito1.getSubcircuito());
            ...
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoNoPresenta = FLocales.ObtenerDatosDadoPermisoMtSubcircuito("No Presenta", lstLocalesSubCircuito1.getSubcircuito());
