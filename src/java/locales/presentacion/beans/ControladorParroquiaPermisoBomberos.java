...
@ManagedBean
@RequestScoped
public class ControladorParroquiaPermisoBomberos {
    ...
    public ControladorParroquiaPermisoBomberos() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaParroquias() {
        ...
        try {
            ...
            lstLocalesDadoParroquia50Si = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("Si", 50);
            lstLocalesDadoParroquia55Si = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("Si", 55);
            lstLocalesDadoParroquia61Si = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("Si", 61);
            ...
            lstLocalesDadoParroquia50No = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("No", 50);
            lstLocalesDadoParroquia55No = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("No", 55);
            lstLocalesDadoParroquia61No = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("No", 61);
            ...
            lstLocalesDadoParroquia50NoPresenta = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("No Presenta", 50);
            lstLocalesDadoParroquia55NoPresenta = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("No Presenta", 55);
            lstLocalesDadoParroquia61NoPresenta = FLocales.ObtenerDatosDadoPermisoBomberosParroquia("No Presenta", 61);
