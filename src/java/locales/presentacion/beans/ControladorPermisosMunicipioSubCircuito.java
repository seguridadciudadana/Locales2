...
@ManagedBean
@RequestScoped
public class ControladorPermisosMunicipioSubCircuito {

    /**
     * Creates a new instance of ControladorPermisosMunicipioSubCircuito
     */
    ...
    public ControladorPermisosMunicipioSubCircuito() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaSubCircuitos() {
        ...
        try {
            ...
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoSi = FLocales.ObtenerDatosDadoPermisoMunicipioSubcircuito("Si", lstLocalesSubCircuito1.getSubcircuito());
            ...
            No.setLabel("No");
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoNo = FLocales.ObtenerDatosDadoPermisoMunicipioSubcircuito("No", lstLocalesSubCircuito1.getSubcircuito());
            ...
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoNoPresenta = FLocales.ObtenerDatosDadoPermisoMunicipioSubcircuito("No Presenta", lstLocalesSubCircuito1.getSubcircuito());
