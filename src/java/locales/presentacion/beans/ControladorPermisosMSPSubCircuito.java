...
@ManagedBean
@RequestScoped
public class ControladorPermisosMSPSubCircuito {

    /**
     * Creates a new instance of ControladorPermisosMSPSubCircuito
     */
    ...
    public ControladorPermisosMSPSubCircuito() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaSubCircuitos() {
        ...
        try {
            ...
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoSi = FLocales.ObtenerDatosDadoPermisoMspSubcircuito("Si", lstLocalesSubCircuito1.getSubcircuito());
            ...
            No.setLabel("No");
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoNo = FLocales.ObtenerDatosDadoPermisoMspSubcircuito("No", lstLocalesSubCircuito1.getSubcircuito());
            ...
            for (Locales lstLocalesSubCircuito1 : lstLocalesSubCircuito) {
                lstLocalesDadoSubCircuitoNoPresenta = FLocales.ObtenerDatosDadoPermisoMspSubcircuito("No Presenta", lstLocalesSubCircuito1.getSubcircuito());
