...
@ManagedBean
@RequestScoped
public class ControladorPermisosMTCircuito {

    /**
     * Creates a new instance of ControladorPermisosMTCircuito
     */
    ...
    public ControladorPermisosMTCircuito() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaCircuitos() {
        ...
        try {
            ...
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoSi = FLocales.ObtenerDatosDadoPermisoMtCircuito("Si", lstLocalesCircuito.get(i).getCircuito());
            ...
            No.setLabel("No");
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoNo = FLocales.ObtenerDatosDadoPermisoMtCircuito("No", lstLocalesCircuito.get(i).getCircuito());
            ...
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoNoPresenta = FLocales.ObtenerDatosDadoPermisoMtCircuito("No Presenta", lstLocalesCircuito.get(i).getCircuito());
