...
@ManagedBean
@RequestScoped
public class ControladorParroquiaPermisoMsp {
    ...
    public ControladorParroquiaPermisoMsp() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaParroquias() {
        ...
        try {
            ...
            lstLocalesDadoParroquia50Si = FLocales.ObtenerDatosDadoPermisoMspParroquia("Si", 50);
            lstLocalesDadoParroquia55Si = FLocales.ObtenerDatosDadoPermisoMspParroquia("Si", 55);
            lstLocalesDadoParroquia61Si = FLocales.ObtenerDatosDadoPermisoMspParroquia("Si", 61);
            ...
            lstLocalesDadoParroquia50No = FLocales.ObtenerDatosDadoPermisoMspParroquia("No", 50);
            lstLocalesDadoParroquia55No = FLocales.ObtenerDatosDadoPermisoMspParroquia("No", 55);
            lstLocalesDadoParroquia61No = FLocales.ObtenerDatosDadoPermisoMspParroquia("No", 61);
            ...
            lstLocalesDadoParroquia50NoPresenta = FLocales.ObtenerDatosDadoPermisoMspParroquia("No Presenta", 50);
            lstLocalesDadoParroquia55NoPresenta = FLocales.ObtenerDatosDadoPermisoMspParroquia("No Presenta", 55);
            lstLocalesDadoParroquia61NoPresenta = FLocales.ObtenerDatosDadoPermisoMspParroquia("No Presenta", 61);
