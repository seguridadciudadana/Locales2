...
@ManagedBean
@RequestScoped
public class ControladorParroquiaPermisoMt {
    ...
    public ControladorParroquiaPermisoMt() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaParroquias() {
        ...
        try {
            ...
            lstLocalesDadoParroquia50Si = FLocales.ObtenerDatosDadoPermisoMtParroquia("Si", 50);
            lstLocalesDadoParroquia55Si = FLocales.ObtenerDatosDadoPermisoMtParroquia("Si", 55);
            lstLocalesDadoParroquia61Si = FLocales.ObtenerDatosDadoPermisoMtParroquia("Si", 61);
            ...
            lstLocalesDadoParroquia50No = FLocales.ObtenerDatosDadoPermisoMtParroquia("No", 50);
            lstLocalesDadoParroquia55No = FLocales.ObtenerDatosDadoPermisoMtParroquia("No", 55);
            lstLocalesDadoParroquia61No = FLocales.ObtenerDatosDadoPermisoMtParroquia("No", 61);
            ...
            lstLocalesDadoParroquia50NoPresenta = FLocales.ObtenerDatosDadoPermisoMtParroquia("No Presenta", 50);
            lstLocalesDadoParroquia55NoPresenta = FLocales.ObtenerDatosDadoPermisoMtParroquia("No Presenta", 55);
            lstLocalesDadoParroquia61NoPresenta = FLocales.ObtenerDatosDadoPermisoMtParroquia("No Presenta", 61);
