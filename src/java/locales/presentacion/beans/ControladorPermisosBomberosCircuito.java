...
@ManagedBean
@RequestScoped
public class ControladorPermisosBomberosCircuito {
    ...
    public ControladorPermisosBomberosCircuito() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaCircuitos() {
        ...
        try {
            ...
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoSi = FLocales.ObtenerDatosDadoPermisoBomberosCircuito("Si", lstLocalesCircuito.get(i).getCircuito());
            ...
            No.setLabel("No");
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoNo = FLocales.ObtenerDatosDadoPermisoBomberosCircuito("No", lstLocalesCircuito.get(i).getCircuito());
            ...
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoNoPresenta = FLocales.ObtenerDatosDadoPermisoBomberosCircuito("No Presenta", lstLocalesCircuito.get(i).getCircuito());
