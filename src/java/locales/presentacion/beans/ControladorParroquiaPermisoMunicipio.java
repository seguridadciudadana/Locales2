...
public class ControladorParroquiaPermisoMunicipio {
    ...
    private CartesianChartModel graficaParroquias() {
        ...
        try {
            ...
            lstLocalesDadoParroquia50Si = FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("Si", 50);
            lstLocalesDadoParroquia55Si = FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("Si", 55);
            lstLocalesDadoParroquia61Si = FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("Si", 61);
            ...
            lstLocalesDadoParroquia50No = FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("No", 50);
            lstLocalesDadoParroquia55No = FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("No", 55);
            lstLocalesDadoParroquia61No = FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("No", 61);
...
//                lstLocalesDadoParroquiaSi=FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("Si",lstLocalesParroquias.get(i).getParroquia());
//                Si.set(lstLocalesParroquias.get(i).getParroquia(), lstLocalesDadoParroquiaSi.size());
//            }
//            
//            for (int i=0;i<lstLocalesParroquias.size();i++){
//                lstLocalesDadoParroquiaNo=FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("No",lstLocalesParroquias.get(i).getParroquia());
//                No.set(lstLocalesParroquias.get(i).getParroquia(), lstLocalesDadoParroquiaNo.size());
//            }
            
             ChartSeries NoPresenta= new ChartSeries();
            NoPresenta.setLabel("No Presentan permiso");
            lstLocalesDadoParroquia50NoPresenta=FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("No Presenta",50);
            lstLocalesDadoParroquia55NoPresenta=FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("No Presenta",55);
            lstLocalesDadoParroquia61NoPresenta=FLocales.ObtenerDatosDadoPermisoMunicipioParroquia("No Presenta",61);                        
