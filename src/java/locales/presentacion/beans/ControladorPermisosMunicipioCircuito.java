...
@ManagedBean
@RequestScoped
public class ControladorPermisosMunicipioCircuito {

    /**
     * Creates a new instance of ControladorPermisosMunicipioCircuito
     */
    ...
    public ControladorPermisosMunicipioCircuito() {
        this.reinit();
    ...
    private CartesianChartModel graficaCircuitos() {
        ...
        try {
            ...
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoSi = FLocales.ObtenerDatosDadoPermisoMunicipioCircuito("Si", lstLocalesCircuito.get(i).getCircuito());
            ...
            No.setLabel("No");
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoNo = FLocales.ObtenerDatosDadoPermisoMunicipioCircuito("No", lstLocalesCircuito.get(i).getCircuito());
            ...
            for (int i = 0; i < lstLocalesCircuito.size(); i++) {
                lstLocalesDadoCircuitoNoPresenta = FLocales.ObtenerDatosDadoPermisoMunicipioCircuito("No Presenta", lstLocalesCircuito.get(i).getCircuito());
