...
public class EncabezadoTutoriaControlador {
    ...
    public EncabezadoTutoriaControlador() {
        this.reinit();
    }
   ...
   private void reinit(){
    ...
    private void cargarEncabezadoTutoria(){
        try {
            this.lstEncabezadoTutoria = FEncabezadoTutoria.ObtenerEncabezadoTutoria();
    ...
    public void insertarEncabezadoTutoria() {
        try {
            ...
            tutores.setCodigo(valorTSeleccionado);
    ...
    public void cambiarEstadoMostrarActualizar(){
     ...
     public void actualizarEncabezadoTutoria() {
        try {
            encabezadoTutoriaSel.setCodigo_tutor(FTutor.ObtenerTutorDadoCodigo((int) encabezadoTutoriaSel.getCodigo_tutor().getCodigo()));
