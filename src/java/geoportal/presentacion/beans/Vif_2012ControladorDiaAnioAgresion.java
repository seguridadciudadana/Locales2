...
public class Vif_2012ControladorDiaAnioAgresion {
    ...
    /**
     * Creates a new instance of Vif_2012ControladorDiaAnioAgresion
     */
    private CartesianChartModel lineModelDiaAgresion;
    private CartesianChartModel lineModelDiaAgresionSexo;
    private CartesianChartModel lineModelMesAgresion;
    private CartesianChartModel lineModelMesAgresionSexo;
    ...
    public CartesianChartModel getLineModelDiaAgresionSexo() {
        return lineModelDiaAgresionSexo;
    }

    public void setLineModelDiaAgresionSexo(CartesianChartModel lineModelDiaAgresionSexo) {
        this.lineModelDiaAgresionSexo = lineModelDiaAgresionSexo;
    }

    public CartesianChartModel getLineModelMesAgresion() {
        return lineModelMesAgresion;
    }

    public void setLineModelMesAgresion(CartesianChartModel lineModelMesAgresion) {
        this.lineModelMesAgresion = lineModelMesAgresion;
    }

    public CartesianChartModel getLineModelMesAgresionSexo() {
        return lineModelMesAgresionSexo;
    }

    public void setLineModelMesAgresionSexo(CartesianChartModel lineModelMesAgresionSexo) {
        this.lineModelMesAgresionSexo = lineModelMesAgresionSexo;
    }
    ...
    public void graficar() {
        ...
        this.lineModelDiaAgresionSexo = graficaDiaAgresionSexoVictima();
        this.lineModelMesAgresion = graficaMesesAgresiones();
        this.lineModelMesAgresionSexo = graficaMesesSexoVictima();
    }
    ...
    private CartesianChartModel graficaMesesAgresiones() {
        CartesianChartModel modelMesesAgresiones = new CartesianChartModel();
        try {
            ...
            modelMesesAgresiones.addSeries(Meses);

        } catch (Exception e) {
        }
        return modelMesesAgresiones;
    }
