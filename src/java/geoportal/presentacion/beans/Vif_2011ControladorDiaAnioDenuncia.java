...
@ManagedBean
@RequestScoped
public class Vif_2011ControladorDiaAnioDenuncia {

    /**
     * Creates a new instance of Vif_2011ControladorDiaAnioDenuncia
     */
    ...
    public void graficar() {
        ...
        this.lineModelDiaDenunciaSexoVictima=graficaDiaDenunciaSexoVictima();
        this.lineModelMesesDenuncia=graficaMesesDenuncia();
        this.lineModelMesesDenunciaSexoVictima=graficaMesesDenunciaSexoVictima();

    }

    public Vif_2011ControladorDiaAnioDenuncia() {
        this.reinit();
    }
    ...
    private CartesianChartModel graficaDiaDenuncia() {
        ...
        try {
            ...
            lstDatosLunes = FVif_2011.ObtenerDatosDadoDiaDenuncia("LUNES");
            lstDatosMartes = FVif_2011.ObtenerDatosDadoDiaDenuncia("MARTES");
            lstDatosMiercoles = FVif_2011.ObtenerDatosDadoDiaDenuncia("MIERCOLES");
            lstDatosJueves = FVif_2011.ObtenerDatosDadoDiaDenuncia("JUEVES");
            lstDatosViernes = FVif_2011.ObtenerDatosDadoDiaDenuncia("VIERNES");
            lstDatosSabado = FVif_2011.ObtenerDatosDadoDiaDenuncia("SABADO");
            lstDatosDomingo = FVif_2011.ObtenerDatosDadoDiaDenuncia("DOMINGO");
    ...
    private CartesianChartModel graficaDiaDenunciaSexoVictima() {
        ...
        try {
            ...
            lstDatosLunesM = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("LUNES", "M");
            lstDatosMartesM = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("MARTES", "M");
            lstDatosMiercolesM = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("MIERCOLES", "M");
            lstDatosJuevesM = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("JUEVES", "M");
            lstDatosViernesM = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("VIERNES", "M");
            lstDatosSabadoM = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("SABADO", "M");
            lstDatosDomingoM = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("DOMINGO", "M");

            //VICTIMAS DEL SEXO FEMENINO
            lstDatosLunesF = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("LUNES", "F");
            lstDatosMartesF = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("MARTES", "F");
            lstDatosMiercolesF = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("MIERCOLES", "F");
            lstDatosJuevesF = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("JUEVES", "F");
            lstDatosViernesF = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("VIERNES", "F");
            lstDatosSabadoF = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("SABADO", "F");
            lstDatosDomingoF = FVif_2011.ObtenerDatosDadoDiaDenunciaSexoVictima("DOMINGO", "F");
    ...
    private CartesianChartModel graficaMesesDenuncia() {
        CartesianChartModel model = new CartesianChartModel();
        try {
            this.lstDatosEnero = FVif_2011.ObtenerDatosDadoMesDenuncia("ENERO");
            this.lstDatosFebrero = FVif_2011.ObtenerDatosDadoMesDenuncia("FEBRERO");
            this.lstDatosMarzo = FVif_2011.ObtenerDatosDadoMesDenuncia("MARZO");
            this.lstDatosAbril = FVif_2011.ObtenerDatosDadoMesDenuncia("ABRIL");
            this.lstDatosMayo = FVif_2011.ObtenerDatosDadoMesDenuncia("MAYO");
            this.lstDatosJunio = FVif_2011.ObtenerDatosDadoMesDenuncia("JUNIO");
            this.lstDatosJulio = FVif_2011.ObtenerDatosDadoMesDenuncia("JULIO");
            this.lstDatosAgosto = FVif_2011.ObtenerDatosDadoMesDenuncia("AGOSTO");
            this.lstDatosSeptiembre = FVif_2011.ObtenerDatosDadoMesDenuncia("SEPTIEMBRE");
            this.lstDatosOctubre = FVif_2011.ObtenerDatosDadoMesDenuncia("OCTUBRE");
            this.lstDatosNoviembre = FVif_2011.ObtenerDatosDadoMesDenuncia("NOVIEMBRE");
            this.lstDatosDiciembre = FVif_2011.ObtenerDatosDadoMesDenuncia("DICIEMBRE");
    ...
    private CartesianChartModel graficaMesesDenunciaSexoVictima() {
        ...
        try {
            this.lstDatosEneroM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("ENERO", "M");
            this.lstDatosFebreroM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("FEBRERO", "M");
            this.lstDatosMarzoM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("MARZO", "M");
            this.lstDatosAbrilM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("ABRIL", "M");
            this.lstDatosMayoM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("MAYO", "M");
            this.lstDatosJunioM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("JUNIO", "M");
            this.lstDatosJulioM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("JULIO", "M");
            this.lstDatosAgostoM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("AGOSTO", "M");
            this.lstDatosSeptiembreM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("SEPTIEMBRE", "M");
            this.lstDatosOctubreM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("OCTUBRE", "M");
            this.lstDatosNoviembreM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("NOVIEMBRE", "M");
            this.lstDatosDiciembreM = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("DICIEMBRE", "M");

            this.lstDatosEneroF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("ENERO", "F");
            this.lstDatosFebreroF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("FEBRERO", "F");
            this.lstDatosMarzoF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("MARZO", "F");
            this.lstDatosAbrilF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("ABRIL", "F");
            this.lstDatosMayoF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("MAYO", "F");
            this.lstDatosJunioF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("JUNIO", "F");
            this.lstDatosJulioF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("JULIO", "F");
            this.lstDatosAgostoF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("AGOSTO", "F");
            this.lstDatosSeptiembreF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("SEPTIEMBRE", "F");
            this.lstDatosOctubreF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("OCTUBRE", "F");
            this.lstDatosNoviembreF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("NOVIEMBRE", "F");
            this.lstDatosDiciembreF = FVif_2011.ObtenerDatosDadoMesDenunciaSexoVictima("DICIEMBRE", "F");
